...
public class Snow_wakeup extends RW_utils{
	...
	public void cred_table_GUI() {
		JTable show_table = new JTable();
		DefaultTableModel table_model = (DefaultTableModel) show_table.getModel();
		Object[] row = new Object[2];
		Object[] column={"Instance Name","Username"};
